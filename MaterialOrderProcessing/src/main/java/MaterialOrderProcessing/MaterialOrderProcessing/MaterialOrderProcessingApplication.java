...
@ComponentScan(basePackages = {"com.mop"})
@EntityScan("com.mop.Entity")
@EnableJpaRepositories("com.mop.Repo")
...
@Configuration
@EnableWebMvc
public class MaterialOrderProcessingApplication implements WebMvcConfigurer {
	...
	public static void main(String[] args) {
		SpringApplication.run(MaterialOrderProcessingApplication.class, args);
	}
}