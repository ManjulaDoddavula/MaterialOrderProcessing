...
import com.mop.DTO.OrderDTO;
import com.mop.Entity.OrderPojo;
import com.mop.Entity.OrderProcessPojo;
import com.mop.Repo.OrderRepo;
import com.mop.Service.OrderService;
...
//                if (processPojo.getProductid() != null && entityManager.find(OrderProcessPojo.class, processPojo.getProductid()) != null) {
...
//        if (k.getOrderid() != null && entityManager.find(OrderPojo.class, k.getOrderid()) != null) {
//            k = entityManager.merge(k);
//        } else {
//            entityManager.persist(k);
//        }
		
        // Convert back to OrderDTO
        //OrderDTO savedOrderDTO = mapper.map(k, OrderDTO.class);
